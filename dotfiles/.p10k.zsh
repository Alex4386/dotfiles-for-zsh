# Generated by Powerlevel10k configuration wizard on 2021-04-09 at 18:34 KST.
...
# 2 lines, dotted, no frame, lightest-ornaments, sparse, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE,REMOTE_SUDO}_FOREGROUND=180
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE,REMOTE_SUDO}_TEMPLATE='%n@%m'
  ...
  typeset -g POWERLEVEL9K_WIFI_CONTENT_EXPANSION='$P9K_WIFI_SSID @ ${P9K_WIFI_RSSI}dBm'
